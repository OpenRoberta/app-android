...
// TODO: delete case "command"
                    case "command":
                        //{"target":"wedo","type":"command","actuator":"motor","brickid":"USB","action":"stop","id":1}
                        //{"target":"wedo","type":"command","actuator":"motor","brickid":"USB","action":"on","id":"1","direction":0,"power":30}
                        int id = msg.getInt("id") - 1;
                        switch (msg.getString("action"))
                        {
                            case "on":
                                // Makeblock:
                                orbManager.configMotor( id,144,50,30,30);
                                //LEGO:
                                // orbManager.configMotor(msg.getInt("id"),72,50,30,30);
                                orbManager.setMotor( id,2,(msg.getInt("direction")==0)?10*msg.getInt("power"):-10*msg.getInt("power"),0);
                                break;

                            case "stop":
                                orbManager.setMotor( id,0,0,0);
                                break;
