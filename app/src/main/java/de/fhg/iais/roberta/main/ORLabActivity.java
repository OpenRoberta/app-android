 ...
 * @since 2018-07-15
 */
public class ORLabActivity extends Activity {
...
//end
        ...
        this.orView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent,
                                        ...
                                        String mimeType,
                                        long contentLength) {
                if (!Util.isWriteStoragePermissionGranted(ORLabActivity.this, REQUEST_WRITE_PERMISSION)) {
                    return;
                }
                DownloadManager downloadManager = (DownloadManager) ORLabActivity.this.getSystemService(DOWNLOAD_SERVICE);
                String content = "";
                File file;
                try {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.settings:
                        AlertDialog prefDialog = Util.createSettingsDialog(ORLabActivity.this, orView);
                        prefDialog.show();
                        break;
                    case R.id.about:
...
//TB: Monitor starten
    ...
    private class orWebViewClient extends WebChromeClient {
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback,
            ...
            if (!Util.isReadStoragePermissionGranted(ORLabActivity.this, REQUEST_READ_PERMISSION)) {
                return false;
            }
            if (orFilePathCallback != null) {
